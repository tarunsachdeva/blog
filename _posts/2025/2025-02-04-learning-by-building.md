...
As an example - when Stable Diffusion was released, I create an app called [Fresco](fresco.lol), a simple game that to create artwork using diffusion models. But instead of trying to mimic hyper-realism (which, at the time, models weren't good at), I made the app focused on creating abstract art, so that the hallucinations and inaccuracy became a feature more than a bug.
